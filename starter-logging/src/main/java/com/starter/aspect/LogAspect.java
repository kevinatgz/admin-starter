 ...
 */
package com.starter.aspect;

import com.starter.common.utils.RequestHolder;
import com.starter.common.utils.SecurityUtils;
import com.starter.common.utils.StringUtils;
import com.starter.common.utils.ThrowableUtil;
import com.starter.domain.Log;
//import com.starter.service.LogService;
...
public class LogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.starter.annotation.Log)")
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        SysLogEntity log = new SysLogEntity("INFO", System.currentTimeMillis() - currentTime.get());
        currentTime.remove();
    ...
    public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
        SysLogEntity log = new SysLogEntity("ERROR", System.currentTimeMillis() - currentTime.get());
        currentTime.remove();
