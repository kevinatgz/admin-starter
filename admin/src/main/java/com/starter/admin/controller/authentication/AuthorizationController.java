 ...
 */
package com.starter.admin.controller.authentication;

import cn.hutool.core.util.IdUtil;
import com.starter.admin.config.bean.LoginCodeEnum;
import com.starter.admin.config.bean.LoginProperties;
import com.starter.admin.config.bean.SecurityProperties;
import com.starter.admin.security.TokenProvider;
import com.starter.admin.service.security.OnlineUserService;
import com.starter.admin.service.security.dto.AuthUserDto;
import com.starter.admin.service.security.dto.JwtUserDto;
import com.starter.common.annotation.rest.AnonymousDeleteMapping;
...
//        log.info("RsaProperties.privateKey=="+rsaProperties.getPriKey());
//        log.info(authUser.getPassword());
        // 密码解密
        String password = RsaUtils.decryptByPrivateKey(RsaProperties.privateKey, authUser.getPassword());
        log.info("password="+password);
        log.info(authUser.getUuid());
        // 查询验证码
...
//            throw new BadRequestException("验证码错误");
        ...
        log.info("token==1  "+authUser.getUsername());
