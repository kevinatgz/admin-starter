...
import com.starter.admin.dao.DeptRepository;
...
import com.starter.admin.service.mapstruct.DeptMapper;
import com.starter.admin.service.system.dto.DeptDto;
import com.starter.admin.service.system.dto.DeptQueryCriteria;
...
public class DeptServiceImpl implements DeptService {
    ...
    public List<DeptDto> queryAll(DeptQueryCriteria criteria, Boolean isQuery) throws Exception {
        ...
        List<DeptDto> list = deptMapper.toDto(deptRepository.findAll((root, criteriaQuery, criteriaBuilder) -> QueryHelp.getPredicate(root,criteria,criteriaBuilder),Sort.by("deptSort")));
